...
pub struct AnthropicSettingsContent {
    ...
    /// API key for the Anthropic provider. If set, this key will be used instead of the OAuth/keychain key.
    pub api_key: Option<String>,
    /// Use Claude Code CLI instead of HTTP requests. When enabled, ChiCode will call the 'claude' command to communicate with the API.
