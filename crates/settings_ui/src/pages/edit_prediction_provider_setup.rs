...
fn render_api_key_provider(
    ...
    let description = h_flex()
        ...
        .gap_0p5()
        .child(
            Label::new(t("settings-visit-the"))
        ...
        .child(
            Label::new(t("settings-to-generate-api-key"))
                .size(LabelSize::Small)
                .color(Color::Muted),
        );
    let configured_card_label = if is_from_env_var {
        t("settings-api-key-env-var")
    } else {
        t("settings-api-key-configured")
    };
            ...
            h_flex()
                ...
                .child(
                    v_flex()
                        .w_full()
                        .max_w_1_2()
                        .child(Label::new(t("settings-api-key")))
                        .child(description)
                        .when_some(env_var_name, |this, env_var_name| {
                            this.child({
