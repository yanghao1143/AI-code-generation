                    ...
                    .child(
                        PopoverMenu::new("terminal-tab-bar-popover-menu")
                            .trigger_with_tooltip(
                                ...
                                Tooltip::text(t("terminal-new-tooltip")),
                            )
                    ...
                    .child(
                        PopoverMenu::new("terminal-pane-tab-bar-split")
                            .trigger_with_tooltip(
                                ...
                                Tooltip::text(t("terminal-split-pane")),
                            )
                            .anchor(Corner::TopRight)
                            ...
                            .menu({
                                move |window, cx| {
                                    ContextMenu::build(window, cx, |menu, _, _| {
                                        ...
                                        .action(t("terminal-split-right"), SplitRight::default().boxed_clone())
                                        .action(t("terminal-split-left"), SplitLeft::default().boxed_clone())
                                        .action(t("terminal-split-up"), SplitUp::default().boxed_clone())
                                        .action(t("terminal-split-down"), SplitDown::default().boxed_clone())
                                    })
                                    .into()
                                }
                            }),
        ...
        let popover_menu = PopoverMenu::new("settings-popover")
            ...
            .menu(move |window, cx| {
                Some(ContextMenu::build(window, cx, |context_menu, _, _| {
                    context_menu
                        .action(t("terminal-open-settings"), zed_actions::OpenSettings.boxed_clone())
                        .action(
                            t("terminal-edit-settings-json"),
        ...
        v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .justify_center()
                    .text_center()
                    .child(Label::new(t("terminal-failed-spawn")))
                    .child(
                    ...
                    .child(SplitButton::new(
                        ButtonLike::new("open-settings-ui")
                            .child(Label::new(t("terminal-edit-settings")).size(LabelSize::Small))
