//! Provides constructs for the Chi Code app version and release channel.
...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Chi-Code-Dev",
        ReleaseChannel::Nightly => "Chi-Code-Nightly",
        ReleaseChannel::Preview => "Chi-Code-Preview",
        ReleaseChannel::Stable => "Chi-Code-Stable",
    }
}

/// The Git commit SHA that Chi Code was built at.
...
/// A Chi Code release channel.
#[derive(Debug, Copy, Clone, PartialEq, Eq, Default)]
pub enum ReleaseChannel {
    /// The development release channel.
    ///
    /// Used for local debug builds of Chi Code.
    #[default]
    Dev,
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            ReleaseChannel::Nightly => "Chi Code Nightly",
            ReleaseChannel::Preview => "Chi Code Preview",
            ReleaseChannel::Stable => "Chi Code",
        }
    }
    ...
    /// and WM_CLASS on X11.
    /// This also has to match the bundle identifier for Chi Code on macOS.
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "com.chicode.ChiCode-Dev",
            ReleaseChannel::Nightly => "com.chicode.ChiCode-Nightly",
            ReleaseChannel::Preview => "com.chicode.ChiCode-Preview",
            ReleaseChannel::Stable => "com.chicode.ChiCode",
        }
    }
