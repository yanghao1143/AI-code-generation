...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Chi Code Dev Instance Running",
        ReleaseChannel::Nightly => "Chi Code Nightly Instance Running",
        ReleaseChannel::Preview => "Chi Code Preview Instance Running",
        ReleaseChannel::Stable => "Chi Code Stable Instance Running",
    }
}
