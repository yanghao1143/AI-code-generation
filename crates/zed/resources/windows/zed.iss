...
AppPublisher=Chi Code
AppPublisherURL=https://vip.chiddns.com/
AppSupportURL=https://vip.chiddns.com/
AppUpdatesURL=https://vip.chiddns.com/
...
[Files]
Source: "{#ResourcesDir}\ChiCode.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
