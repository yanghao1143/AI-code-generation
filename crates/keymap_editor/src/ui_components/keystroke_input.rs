...
impl Render for KeystrokeInput {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let search_indicator = h_flex()
            ...
            .child(
                Label::new(t("keymap-editor-search"))
                    .size(LabelSize::XSmall)
                    .weight(FontWeight::SEMIBOLD)
                    .color(Color::Accent),
            );
                                ...
                                IconButton::new("stop-record-btn", IconName::Stop)
                                    ...
                                    .map(|this| {
                                        this.tooltip(Tooltip::for_action_title(
                                            if self.search {
                                                t("keymap-editor-stop-searching")
                                            } else {
                                                t("keymap-editor-stop-recording")
                                            },
                                            &StopRecording,
                                        ))
                                    })
                            ...
                            this.child(
                                IconButton::new("record-btn", record_icon)
                                    ...
                                    .map(|this| {
                                        this.tooltip(Tooltip::for_action_title(
                                            if self.search {
                                                t("keymap-editor-start-searching")
                                            } else {
                                                t("keymap-editor-start-recording")
                                            },
                                            &StartRecording,
                                        ))
                                    })
                    ...
                    .when(is_recording, |this| {
                        this.child(
                            IconButton::new("clear-btn", IconName::Backspace)
                                ...
                                .tooltip(move |_, cx| {
                                    Tooltip::with_meta(
                                        t("keymap-editor-clear-keystrokes"),
                                        Some(&ClearKeystrokes),
                                        t("keymap-editor-clear-keystrokes-hint"),
                                        cx,
                                    )
                                })
                                .when(!is_focused, |this| this.icon_color(Color::Muted))
