...
const CONTENT: (Section<4>, Section<3>) = (
    Section {
        title_key: "welcome-get-started",
        entries: [
            SectionEntry {
                icon: IconName::Plus,
                title_key: "welcome-new-file",
                action: &NewFile,
            },
            SectionEntry {
                icon: IconName::FolderOpen,
                title_key: "welcome-open-project",
                action: &Open,
            },
            SectionEntry {
                icon: IconName::CloudDownload,
                title_key: "welcome-clone-repo",
                action: &GitClone,
            },
            SectionEntry {
                icon: IconName::ListCollapse,
                title_key: "welcome-command-palette",
                action: &command_palette::Toggle,
            },
        ],
    },
    Section {
        title_key: "welcome-configure",
        entries: [
            SectionEntry {
                icon: IconName::Settings,
                title_key: "welcome-open-settings",
                action: &OpenSettings,
            },
            SectionEntry {
                icon: IconName::ZedAssistant,
                title_key: "welcome-view-ai-settings",
                action: &agent::OpenSettings,
            },
            SectionEntry {
                icon: IconName::Blocks,
                title_key: "welcome-explore-extensions",
                action: &Extensions {
...
impl<const COLS: usize> Section<COLS> {
    fn render(self, index_offset: usize, focus: &FocusHandle, cx: &App) -> impl IntoElement {
        v_flex()
            .min_w_full()
            .child(SectionHeader::new(t(self.title_key)))
            .children(
                self.entries
                    .iter()
                    .enumerate()
...
impl WelcomePage {
    ...
    fn render_recent_project_section(
        ...
        v_flex()
            .w_full()
            .child(SectionHeader::new(t("welcome-recent-projects")))
                                ...
                                h_flex()
                                    ...
                                    .child(
                                        v_flex().child(Headline::new(welcome_label)).child(
                                            Label::new(t("onboarding-tagline"))
                            ...
                            .when(!self.fallback_to_recent_projects, |this| {
                                this.child(
                                    v_flex().gap_1().child(Divider::horizontal()).child(
                                        Button::new("welcome-exit", t("welcome-return-to-onboarding"))
