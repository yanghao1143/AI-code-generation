    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new(t_args("lm-api-key-steps", &[("agent", t("lm-zed-agent-mistral"))])))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
                                .child(Label::new(t("lm-create-key-by-visiting")))
                                .child(ButtonLink::new(t("lm-mistral-console"), "https://console.mistral.ai/api-keys"))
                        )
                        .child(
                            ListBulletItem::new(t("lm-mistral-ensure-credits"))
                        )
                        .child(
