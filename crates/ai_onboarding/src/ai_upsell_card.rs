        ...
        match self.sign_in_status {
            SignInStatus::SignedIn => match self.user_plan {
                None | Some(Plan::V2(PlanV2::ZedFree)) => card
                    .child(Label::new(t("ai-try-ai")).size(LabelSize::Large))
                    .map(|this| {
                        if self.account_too_young {
                            ...
                            .child(
                                footer_container
                                    .child(
                                        Button::new("start_trial", t("ai-start-trial"))
                                            .full_width()
                                            .style(ButtonStyle::Tinted(ui::TintColor::Accent))
                ...
                Some(Plan::V2(PlanV2::ZedProTrial)) => card
                    ...
                    .child(Label::new(t("ai-pro-trial")).size(LabelSize::Large))
                    .child(
                ...
                Some(Plan::V2(PlanV2::ZedPro)) => card
                    ...
                    .child(Label::new(t("ai-pro-plan")).size(LabelSize::Large))
                    .child(
