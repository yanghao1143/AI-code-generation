...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            .relative()
            .gap_1()
            .child(Headline::new(t("ai-welcome")))
            .child(
                Label::new(t("ai-sign-in-trial"))
                    .color(Color::Muted)
                    .mb_2(),
            )
            .child(PlanDefinitions.pro_plan())
            .child(
                Button::new("sign_in", t("ai-try-pro-free"))
                    .disabled(signing_in)
                    .full_width()
            ...
            v_flex()
                ...
                .child(
                    v_flex()
                        ...
                        .child(PlanDefinitions.pro_plan())
                        .child(
                            Button::new("pro", t("ai-get-started"))
                                .full_width()
                                .style(ButtonStyle::Tinted(ui::TintColor::Accent))
            ...
            v_flex()
                ...
                .child(
                    v_flex()
                        ...
                        .child(
                            Button::new("pro", t("ai-start-free-trial"))
                                .full_width()
                                .style(ButtonStyle::Tinted(ui::TintColor::Accent))
                                .on_click(move |_, _window, cx| {
                                    telemetry::event!(
    ...
    fn render_trial_state(&self, _cx: &mut App) -> AnyElement {
        v_flex()
            .relative()
            .gap_1()
            .child(Headline::new(t("ai-welcome-pro-trial")))
            .child(
                Label::new(t("ai-trial-benefits"))
                    .color(Color::Muted)
                    .mb_2(),
            )
    ...
    fn render_pro_plan_state(&self, _cx: &mut App) -> AnyElement {
        v_flex()
            .gap_1()
            .child(Headline::new(t("ai-welcome-pro")))
            .child(
                Label::new(t("ai-pro-benefits"))
                    .color(Color::Muted)
                    .mb_2(),
            )
            .child(PlanDefinitions.pro_plan())
