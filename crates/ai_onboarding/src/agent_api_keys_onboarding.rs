...
impl RenderOnce for ApiKeysWithoutProviders {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        v_flex()
            ...
            .child(List::new().child(ListBulletItem::new(t("ai-add-keys-hint"))))
            .child(
                Button::new("configure-providers", t("ai-configure-providers"))
                    .full_width()
