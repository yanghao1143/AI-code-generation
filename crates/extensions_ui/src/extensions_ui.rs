...
impl ExtensionsPage {
                ...
                h_flex()
                    ...
                    .child(
                        h_flex()
                            ...
                            .child(
                                Button::new(SharedString::from(extension.id.clone()), t("extensions-uninstall"))
                                    .color(Color::Accent)
    ...
    fn buttons_for_entry(
        ...
        match status.clone() {
            ...
            ExtensionStatus::Upgrading => ExtensionCardButtons {
                ...
                upgrade: Some(
                    Button::new(SharedString::from(extension.id.clone()), t("extensions-upgrade")).disabled(true),
                ),
            },
            ExtensionStatus::Installed(installed_version) => ExtensionCardButtons {
                ...
                upgrade: if installed_version == extension.manifest.version {
                    ...
                    Some(
                        Button::new(SharedString::from(extension.id.clone()), t("extensions-upgrade"))
                          .style(ButtonStyle::Tinted(ui::TintColor::Accent))
    ...
    fn render_empty_state(&self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let message = if self.is_fetching_extensions {
            ...
            t("extensions-fetch-failed")
        } else {
            match self.filter {
                ExtensionFilter::All => {
                    if has_search {
                        t("extensions-no-match")
                    } else {
                        t("extensions-no-extensions")
                    }
                }
                ExtensionFilter::Installed => {
                    if has_search {
                        t("extensions-no-installed-match")
                    } else {
                        t("extensions-no-installed")
                    }
                }
                ExtensionFilter::NotInstalled => {
                    if has_search {
                        t("extensions-no-not-installed-match")
                    } else {
                        t("extensions-no-not-installed")
                    }
                }
            }
        };
    ...
    fn render_feature_upsell_banner(
        ...
        let docs_url_button = Button::new("open_docs", t("extensions-view-docs"))
                                ...
                                h_flex()
                                    ...
                                    .child(
                                        h_flex()
                                            .pl_1()
                                            .gap_1()
                                            .child(Label::new(t("extensions-enable-vim")))
                                            .child(
                                                Switch::new(
                                                    "enable-vim",
        ...
        v_flex()
                ...
                v_flex()
                    ...
                    .child(
                        h_flex()
                            ...
                            .gap_1p5()
                            .justify_between()
                            .child(Headline::new(t("extensions-title")).size(HeadlineSize::XLarge))
                            .child(
                                Button::new("install-dev-extension", t("extensions-install-dev"))
            ...
            .child(
                h_flex()
                    ...
                    .overflow_x_scroll()
                    .child(
                        Button::new("filter-all-categories", t("extensions-all"))
