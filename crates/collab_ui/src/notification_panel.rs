                                ...
                                .children(if let Some(is_accepted) = response {
                                    ...
                                    Some(
                                        h_flex()
                                            .flex_grow()
                                            .justify_end()
                                            .child(Button::new("decline", t("collab-decline")).on_click({
                                            ...
                                            .child(Button::new("accept", t("collab-accept")).on_click({
                                                let notification = notification.clone();
                                                let entity = cx.entity();
                                                move |_, _, cx| {
                                                    entity.update(cx, |this, cx| {
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Label::new(t("panel-notifications")))
                ...
                if !self.client.status().borrow().is_connected() {
                    this.child(
                        v_flex()
                            ...
                            .p_4()
                            .child(
                                Button::new("connect_prompt_button", t("collab-connect"))
                            ...
                            .child(
                                div().flex().w_full().items_center().child(
                                    Label::new(t("collab-connect-required"))
                                        .color(Color::Muted)
                    ...
                    this.child(
                        v_flex().p_4().child(
                            div().flex().w_full().items_center().child(
                                Label::new(t("collab-no-notifications"))
                                    .color(Color::Muted)
                                    .size(LabelSize::Small),
                            ),
                        ),
